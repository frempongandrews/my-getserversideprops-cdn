        ...
        <div>
            ...
            <div className="description">
                ...
                <ul>
                    ...
                    <li>If request is made after 180 seconds (stale-while-revalidate) then the stale response isnt used at all, and both fulfilling the browsers request and the cache revalidation will depend on getting a response back from the network</li>
                </ul>
            </div>
